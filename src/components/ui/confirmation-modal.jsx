    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md sm:max-w-lg">
        <DialogHeader className="text-center pb-4">
          <div className={`mx-auto mb-4 h-14 w-14 rounded-full ${variantConfig.iconBg} flex items-center justify-center`}>
            <IconComponent className={`h-7 w-7 ${variantConfig.iconColor}`} />
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex space-x-3 pt-4">
            ...
            <Button 
              ...
              className={`flex-1 text-white transition-all disabled:opacity-50 disabled:cursor-not-allowed ${variantConfig.buttonColor}`}
            >
              {isLoading ? (
